...
export default function DocsLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-dvh bg-brand-surface text-brand-ink">
      <SiteHeader />
      <div className="mx-auto flex max-w-content gap-10 px-6 pt-32 pb-24 sm:px-8">
        <aside className="sticky top-28 hidden h-[calc(100dvh-10rem)] w-56 shrink-0 overflow-y-auto lg:block">
